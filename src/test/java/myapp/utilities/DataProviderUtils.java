...
public class DataProviderUtils {
    ...
    //    Data Provider to get the user credentials from the EXCEL SHEET called 'user_data'(for Day18_DataProvide2 class)
    @DataProvider //(parallel = true) //to enable parallel testing we use (parallel = true)
