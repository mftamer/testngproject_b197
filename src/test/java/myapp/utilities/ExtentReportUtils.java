...
//        Create the HTML template using an extent spark reporter in the path
...
//        connecting extent reports and extent spark reporter
    ...
    //
    /*
     **********CREATE EXTENT TEST ALSO KNOWN AS LOGGER**
     * use this before any other report method to create test; otherwise you get an exception
     */
